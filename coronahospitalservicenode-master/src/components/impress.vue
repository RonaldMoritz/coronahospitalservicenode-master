<template>
  ...
  <div class="impress">
    <p>Diese Webseite ist eine Gruppenarbeit im Rahmen der Lehrveranstaltung "Service Engineering" an der Johannes
      Kepler Universität Linz unter der Leitung von Johannes Sametinger, Reinhold Plösch, Rainer Weinreich und
      Manuel Wimmer entstanden.</p>
    <p>Team 03: Stefan Bolda, Elias van der Linden, Sebastian Spitzer, Marco Stadler</p>
  </div>
